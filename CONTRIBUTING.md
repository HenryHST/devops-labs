...
Thank you for your interest in contributing to DevOps Labs! We welcome contributions from the community.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/henryhst/devobs-labs.git
   cd azure-agent
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/henryhst/devops-labs
   ```
...
- **Issues** - Report bugs and request features via [GitHub Issues](https://github.com/henryhst/devops-labs/issues)
- **Discussions** - Ask questions in [GitHub Discussions](https://github.com/henryhst/devops-labs/discussions)
